                    ...
                    <div className="room">
                                    ...
                                    <div className="thread">
                                        ...
                                        {/* <div className="thread__top">
                                            <div className="thread__author">
                                                <a href="/profile/1/" className="thread__authorInfo">
                                                    <div className="avatar avatar--small">
                                                        <img src="/images/Profile_picture_QKqsL3j.png" />
                                                    </div>
                                                    <span>@{room.host.name}</span>
                                                </a>
                                                <span className="thread__date">23&nbsp;hours, 42&nbsp;minutes ago</span>
                                            </div>


                                            <a href="/delete-message/3/">
                        ...
                        <div className="room__message">
                            <form action="" method="POST" onSubmit={(e) => {
                                ...
                                <input type="hidden" name="csrfmiddlewaretoken" value="CHkYOQPZkGG41qC1SgAf4wb036mUL60o3dJku8KJZ2MFvvNQBeX50zGzzH0bTMOk" />
